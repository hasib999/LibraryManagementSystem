...
public class Book
{
    ...
    [Range(1000, 2100), Display(Name="Publication year")] public int PublicationYear { get; set; }
    [Range(1, int.MaxValue)] public int Quantity { get; set; }
    [Range(0, int.MaxValue), Display(Name="Available quantity")] public int AvailableQuantity { get; set; }
    [Required, StringLength(20), Display(Name="Shelf number")] public string ShelfNumber { get; set; } = string.Empty;
